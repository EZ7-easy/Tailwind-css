...
function Nav() {
  ...
  return (
      <section className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-3'>
        <img src={mainlogo} className="w-[170px] h-[90px]" alt="Flowbite Logo"/>
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul className="flex flex-col md:p-0  font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-6 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="#">Home</a>
            </li>
            <li>
        ...
        <ul className={nav ? 'z-10 fixed left-0 top-0 w-[60%] h-full fill-[rgba(255,255,255,0.91)] backdrop-blur-[9.5px] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
          <img src={mainlogo} className="w-[200px] h-[95px] mt-8 mb-10" alt=""/>
